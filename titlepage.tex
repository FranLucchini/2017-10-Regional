...
\begin{document}
  ...
  \large{\phase}
  \vskip 10pt
  \normalsize{\it 7 de Octubre, \the\year}


  \vskip 95pt

  \emph{Este conjunto de problemas se utiliza simultáneamente en las siguientes sedes:}
  \vskip 10pt

  Arica, Iquique, Viña, Santiago, Talca, Chill\'an, Concepci\'on y Temuco
  ...
  \emph{Las siguientes personas participaron en la elaboración de este conjunto
    de problemas:}
  \vskip 10pt
  Rodrigo Alonso, Sebastián Barbieri, Nicolás Lehmann,
  \vskip 0.5pt
  Juan Pablo Paulsen, Jorge Pérez y Bernardo Subercaseaux
  \end{center}
